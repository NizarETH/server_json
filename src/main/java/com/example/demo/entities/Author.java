...
public class Author implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3255777854353826438L;
	private int id;
    ...
    public Author(String first_name, String last_name, Company company, String function, String contact_details, String statement) {
        this.first_name = first_name;
        this.last_name = last_name;
        this.company = company;
        this.function = function;
