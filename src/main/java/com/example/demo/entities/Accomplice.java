 ...
 */
public class Accomplice implements Serializable {
    ...
    public Accomplice(String first_name, String last_name, Company company, String function, String contact_details, String statement) {
        this.first_name = first_name;
        this.last_name = last_name;
        this.company = company;
        this.function = function;
